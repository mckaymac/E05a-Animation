...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        # Update the screen to show that the ball has moved
    def update(self, delta_time):
        self.ball.update()

        # Move the ball in the direction of the arrow key that was pressed
    ...
    # Stops the ball from moving when key is released
